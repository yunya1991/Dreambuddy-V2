...
def main():
    print("=" * 90)
    print("  MA200牛熊经验法则 vs 综合最优LR vs 买入持有（9年数据）")
    print("=" * 90)
    ...
    for symbol, name in symbols:
        ...
        strategies = [
            ("MA200牛熊(5日斜率)", lambda: MA200TrendFollowingStrategy(
            ...
            ("MA200(20日斜率)", lambda: MA200TrendFollowingStrategy(
                ma_period=200, slope_period=20, max_position=1.0, warmup_periods=225
            )),
        ...
        print(f"\n  {'策略':>16} {'收益%':>10} {'夏普':>8} {'回撤%':>8} {'交易':>6} {'持仓天':>8}")
        print(f"  {'-'*72}")
    ...
    print(f"\n  {'策略':>16} {'BTC':>10} {'ETH':>10} {'SOL':>10} {'UNI':>10} {'平均':>10} {'夏普':>8} {'回撤%':>8} {'交易':>6}")
    print(f"  {'-'*95}")

    strat_names = ["MA200牛熊(5日斜率)", "MA200(3日斜率)", "MA200(10日斜率)", "MA200(20日斜率)",
                   "MA150牛熊", "MA100牛熊", "MA250牛熊", "综合最优LR", "双均线20/200", "买入持有"]
    ...
    for sname in strat_names:
        ...
        if sname == "买入持有":
            ...
            while len(vals) < 4:
                vals.append(0)
            print(f"  {sname:>16} {vals[0]:>+9.2f}% {vals[1]:>+9.2f}% "
