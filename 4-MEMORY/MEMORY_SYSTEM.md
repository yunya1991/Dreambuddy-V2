...
> **⚠️ 已过时（不建议新引用）**
>
> - 当前版本：v2.0 (2026-05-14)，严重过时
> - **权威替代**：[MEMORY_SYSTEM_ARCHITECTURE.md](./MEMORY_SYSTEM_ARCHITECTURE.md) v5.0（双层架构：总记忆+应用记忆）
> - 本文档**保留不移动**：项目中存在遗留链接与代码注释引用本文件（如 app_memory_interface.py 中"对齐 MEMORY_SYSTEM.md 签名"注释），物理移动将破坏引用链
> - 不建议再添加指向本文件的新链接，新文档请使用 v5.0 权威入口
> - 如需了解过时点，详见 [README.md 文档权威性矩阵](./README.md#文档权威性矩阵2026-09-03-对齐)
