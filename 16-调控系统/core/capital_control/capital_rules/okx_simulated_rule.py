...
系统对应：yijing_bcrm ｜ 账户：AccountType.OKX_SIMULATED
优先级：20
"""
...
_SYSTEM_NAME = "yijing_bcrm"
_ACCOUNT_TYPE = AccountType.OKX_SIMULATED
_DEFAULT_STATIC = 150.0


@register_capital(
    name="capital.okx_simulated",
    priority=20,
    config_schema={
        "fallback_static_budget": {"type": "object", "default": {_SYSTEM_NAME: _DEFAULT_STATIC}},
    },
    description="易经推理 OKX 模拟盘资金查询（复用 unified_position_query 缓存）",
)
def okx_simulated_capital_handler(
    ...
    return build_result_from_system(
        ...
        context=ctx,
        extra_extract={"source": "unified_position_query#fetch_yijing_positions"},
    )
