...
const ENDPOINT = "/api/fundamental/breadth/snapshot";
...
export default function BreadthPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <ResearchHeader module="breadth" title="📊 市场广度" onRefresh={loadData} lastUpdated={lastUpdated} loading={loading} />
      ...
      {data && (
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <MetricsCard metrics={data.metrics || {}} title="广度指标" />
          </div>
