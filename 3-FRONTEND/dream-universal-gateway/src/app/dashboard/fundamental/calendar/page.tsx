...
const ENDPOINT = "/api/fundamental/calendar/snapshot";
...
export default function CalendarPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <ResearchHeader module="calendar" title="📅 宏观日历" onRefresh={loadData} lastUpdated={lastUpdated} loading={loading} />
      ...
      {data && (
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <MetricsCard metrics={data.metrics || {}} title="日历指标" />
          </div>
