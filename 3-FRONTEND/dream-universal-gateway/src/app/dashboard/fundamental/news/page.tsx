...
const ENDPOINT = "/api/fundamental/news/snapshot";
...
export default function NewsPage() {
  ...
  const categoryData = data?.events?.reduce((acc: Record<string, number>, event) => {
        ...
        <div className="flex-1 overflow-y-auto p-6">
          <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: "2fr 1fr" }}>
            ...
            <MetricsCard
              metrics={{
                ...data.resistance_3d,
                confidence: data.resistance_3d.confidence,
                data_points: data.resistance_3d.data_points,
              }}
              title="核心指标"
            />
          </div>
