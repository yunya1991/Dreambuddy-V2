...
const ENDPOINT = "/api/fundamental/intermarket/snapshot";
...
export default function IntermarketPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <ResearchHeader module="intermarket" title="🌐 跨市场" onRefresh={loadData} lastUpdated={lastUpdated} loading={loading} />
      ...
      {data && (
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <MetricsCard metrics={data.metrics || {}} title="跨市场指标" />
          </div>
