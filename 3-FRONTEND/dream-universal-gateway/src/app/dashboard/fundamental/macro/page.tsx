...
const ENDPOINT = "/api/fundamental/macro/snapshot";
...
export default function MacroPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <ResearchHeader module="macro" title="🌐 宏观研究" onRefresh={loadData} lastUpdated={lastUpdated} loading={loading} />
      ...
      {data && (
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="grid gap-4 mb-4" style={{ gridTemplateColumns: "1fr 1fr" }}>
            ...
            <MetricsCard metrics={data.metrics || {}} title="宏观指标" />
          </div>
