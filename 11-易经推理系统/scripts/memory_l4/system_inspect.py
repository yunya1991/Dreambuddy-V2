...
用法:
  python -m scripts.memory_l4.system_inspect              # 完整诊断（表格输出）
  python -m scripts.memory_l4.system_inspect --brief      # 摘要模式
  python -m scripts.memory_l4.system_inspect --json       # JSON 输出
  python -m scripts.memory_l4.system_inspect --watch 60   # 持续监控
  python -m scripts.memory_l4.system_inspect --panels system,positions,knowledge  # 指定面板
"""
import argparse
import json
import time
