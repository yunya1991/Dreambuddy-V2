...
PRESET_CONFIGS = {
    MARKET_CAP_LARGE: FeatureConfig(
        ...
        enable_merrill=True,  # 启用美林时钟测试效果
    ...
    MARKET_CAP_SMALL: FeatureConfig(
        ...
        enable_fibonacci=True,
        enable_pivot=True,
        enable_rsi=False,  # 小市值待验证
        enable_wdh=True,
        wdh_weekly_only=False,
        enable_cycle=False,  # 小市值周期不明显, 禁用
        cycle_halving=False,
        cycle_ath=False,
        ...
        enable_cross_asset=True,
        enable_mcap_feature=True,
        enable_meta_labeling=True,  # 小市值启用L2 Meta-Labeling
        enable_merrill=False,  # 小市值资金流转不明显, 禁用
