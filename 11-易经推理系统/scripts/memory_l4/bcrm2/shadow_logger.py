...
class ShadowLogger:
    ...
    def record_polling(self, symbol: str, inference: Dict[str, Any],
                       ...
                       three_factor_short_signal: bool = None,
                       btc_regime: str = None,
                       sal_type: str = None,
                       sal_regime: str = None,
        ...
        record = {
            ...
            # T5 五维评分明细（crypto / us_stock / precious_metal）
            ...
            "fd_precious_metal_dao_score": fd_precious_metal_dao_score,
            "fd_precious_metal_tian_score": fd_precious_metal_tian_score,
            "fd_precious_metal_di_score": fd_precious_metal_di_score,
            "fd_precious_metal_jiang_score": fd_precious_metal_jiang_score,
            "fd_precious_metal_fa_score": fd_precious_metal_fa_score,
            # T5 方向状态（基于分数的细粒度方向偏置）
            "direction_state": direction_state,
            "direction_bias": direction_bias,
            # Phase 4.3 三因子共振做空信号 + BTC 强弱 regime
            "three_factor_short_signal": three_factor_short_signal,
