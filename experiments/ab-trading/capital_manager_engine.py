...
class CapitalManagerEngine:
    ...
    def run_backtest(self, coins=None) -> dict:
        ...
        返回:
            {
                "level_stats": {1: {count, total_pnl, wins, losses}, ...},
                "total_trades": int,
                "coin_results": {coin: {metrics...}, ...},
                "timestamp": str,
            }
        """
        ...
        try:
            sys.path.insert(0, str(ROOT_DIR / "14-V15经典马丁策略" / "core"))
    ...
    def _update_config_file(self, params: dict):
        ...
        replacements = {
            ...
            "TREND_FILTER_MODE": params.get("trend_filter_mode", "both_bear"),
            "TREND_FILTER_PERIOD": str(params.get("trend_filter_period", 104)),
        }
