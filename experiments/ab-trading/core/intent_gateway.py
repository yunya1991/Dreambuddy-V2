...
def _build_chain(intent_type: str, confidence: float,
    ...
    BASE_CHAINS = {
        ...
        # A9离场评估在A4门禁后（有持仓时执行离场决策）
        "TREND_FOLLOWING":  ["C1_技术扫描", "F2_资金流", "F3_情绪", "A2_分析(含A0)", "A4_门禁", "A9_离场评估"],
        # 均值回归：情绪极值驱动，A2分析
        "MEAN_REVERSION":   ["C1_技术扫描", "F2_资金流", "F3_情绪", "A2_分析(含A0)", "A4_门禁", "A9_离场评估"],
        # 基本面驱动：必须A1深度调研（含A0矛盾检测）
        "FUNDAMENTAL_PLAY": ["A1_调研(含A0)", "F1_新闻", "F5_宏观", "A2_分析(含A0)", "A4_门禁", "A9_离场评估"],
        # 突破：技术信号+A2+策略匹配
        "BREAKOUT":         ["C1_技术扫描", "A2_分析(含A0)", "C3_策略匹配", "A4_门禁", "A9_离场评估"],
        # 知识库命中：跳过研究，直接策略
        "KNOWLEDGE_MATCH":  ["C3_策略匹配", "A4_门禁", "A9_离场评估"],
        # 不确定：完整A1调研
        "UNCERTAIN":        ["C1_技术扫描", "A1_调研(含A0)", "A2_分析(含A0)", "A4_门禁", "A9_离场评估"],
    }
