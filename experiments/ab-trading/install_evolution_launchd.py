...
PLIST_SRC = PROJECT_DIR / "com.dreambuddy.evolution_scheduler.plist"
...
def install():
    print("=" * 50)
    print("  Agent A 进化复盘调度器 - Launchd 安装")
    print("=" * 50)
    print()
    ...
    print()
    print(f"服务标签: {LABEL}")
    print(f"执行时间: 每日凌晨 02:00")
    print(f"开机自启: 是")
    print(f"主日志文件: {LOG_DIR}/evolution.log")
    print(f"launchd 日志: {LOG_DIR}/evolution_launchd.log")
    print()
    print("常用命令：")
    print(f"  查看状态: launchctl list | grep {LABEL}")
    print(f"  手动触发: launchctl kickstart gui/{UID}/{LABEL}")
    print(f"  查看主日志: tail -f {LOG_DIR}/evolution.log")
    print(f"  查看启动日志: tail -f {LOG_DIR}/evolution_launchd.log")
